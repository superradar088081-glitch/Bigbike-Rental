...
export const vehicleSchema = z.object({
  ...
  engineCC: z.number().int().positive('CC ต้องมากกว่า 0'),
  ...
  seatHeight: z.number().int().optional(),
  weightKg: z.number().int().optional(),
  description: z.string().optional(),
  imageUrl: z.string().url('URL รูปภาพไม่ถูกต้อง'),
  images: z.array(z.string()).default([]),
  rentalPricePerDay: z.number().positive('ราคาเช่าต้องมากกว่า 0'),
  depositAmount: z.number().nonnegative('เงินมัดจำต้องไม่ติดลบ'),
